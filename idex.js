...
Client.on("ready", () => {
	console.log("online");
	Client.user.setPresence({ game: { name: `Disy Official Bot`, type: 0} });
});
...
Client.on("message", async (message) => {
	...
	if (command == "creator") {
		...
		.addField("Main Creator", "Twelvey#9569")
		message.channel.send({embed})
	}
...
Client.login("NDY0MTg0MjE2MjUxNDAwMTky.Dh7Q0Q.Lzcb4PiHITMLeZY3P8X0f7NVdzc");
